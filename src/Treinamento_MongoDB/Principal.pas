...
type
  TForm1 = class(TForm)
    ...
    procedure Unset2Click(Sender: TObject);
    procedure Max1Click(Sender: TObject);
    procedure CorrentDate1Click(Sender: TObject);
    procedure AddToSte1Click(Sender: TObject);
    procedure Pop1Click(Sender: TObject);
    procedure Pull1Click(Sender: TObject);
    procedure Push1Click(Sender: TObject);
    procedure RemoveSimples1Click(Sender: TObject);
  private
...
procedure TForm1.AddToSte1Click(Sender: TObject);
begin
  ...
  .Modify
     .AddToSet()
     .Field('Novo','Incluindo no AddToSet')   //Criar colunas arrays no banco
     .Field('Frutas',['Banana','Pera','Uva'])
    .&End
   .&End
   .Exec;
...
begin
  ...
  .&End
  .Modify
    .Max   //Altera somente se o valor for inferior.
     .Field('Idade',30)
    .&End
   .&End
   .Exec;
...
begin
  ...
  .Modify
     .Pop()
     .First('Livros')   //Esclui o primeiro ou ultimo de cada array
     .Last('Frutas')
    .&End
   .&End
   .Exec;
...
procedure TForm1.Pull1Click(Sender: TObject);
begin
  FConMongo['CURSO']['INSERT']
  .Update()
  .Match
  ...
  .Modify
     .Pull()
     .Where('Frutas','{$in:["Maça"]}')  //Remove elementos do array baseado em parâmetros
    .&End
   .&End
   .Exec;
...
procedure TForm1.Push1Click(Sender: TObject);
begin
   FConMongo['CURSO']['INSERT']
  .Update()
  .Match
  ...
  .Modify
     .Push()
      .Field('Frutas','Abacate')  //Adicona elementos do array baseado em parâmetros
    .&End
   .&End
   .Exec;
...
procedure TForm1.RemoveSimples1Click(Sender: TObject);
begin
 FConMongo['CURSO']['INSERT'].Remove()
    .Match
      .Add('Nome','Victor')
     .&End
     .Exec;
...
procedure TForm1.Unset2Click(Sender: TObject);
begin
  FConMongo['CURSO']['INSERT']
  .Update()
  .Match
  ...
  .&End
  .Modify
    .Min   //Altera somente se o valor for superior.
     .Field('Idade',15)
    .&End
   .&End
   .Exec;
...
procedure TForm1.CorrentDate1Click(Sender: TObject);
begin
   FConMongo['CURSO']['INSERT']
  .Update()
  .Match
  ...
  .&End
  .Modify
    .CurrentDate   //Permite incluir campos na tabela para gravar a ultima data e hora, para usar como log
     .AsDate('Data')
...
begin
  ...
  vDoc.Add('_id', 1) // Serva para gravar um id proprio
    .Add('Nome', 'Josiel').Add('Idade', '38')
      .BeginArray('Filhos')
        .Add('Nome', 'Victor')
        .Add('Nome', 'Estella')
      .EndArray.BeginArray('Livros')
     .BeginObject('Livros1')
       .Add('Titulo', 'Habitos')
       .Add('Editora', 'Abril')
       .Add('Ano', 2022)
    .EndObject.BeginObject('livro2').Add('Titulo', 'A Cabana')
